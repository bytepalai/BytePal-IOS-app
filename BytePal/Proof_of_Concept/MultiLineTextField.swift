...
struct MultiLineTextField: View {
    ...
    // Text Entry box (content and placeholder)
    ...
    var body: some View {
        UITextViewWrapper(text: self.internalText, calculatedHeight: $viewHeight, onDone: onCommit)
            .frame(minWidth: 50, maxWidth: 50, minHeight: viewHeight, maxHeight: viewHeight)
...
private struct UITextViewWrapper: UIViewRepresentable {
    ...
    func updateUIView(_ uiView: UITextView, context: UIViewRepresentableContext<UITextViewWrapper>) {
        print("UIView.window = \(uiView.window != nil)")
        print("UIView.firstResponder = \(!uiView.isFirstResponder)")
