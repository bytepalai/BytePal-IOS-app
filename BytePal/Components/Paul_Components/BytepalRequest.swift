...
class MakeRequest {
    ...
    static func sendMessage(message: String, userID: String,  completion: @escaping (String, String) -> Void) {
    ...
    var request = URLRequest(url: URL(string: "\(API_HOSTNAME)/interact")!,timeoutInterval: Double.infinity)
